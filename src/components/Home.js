...
const Home = () => {
  ...
  return (
    ...
    <div class="container mt-5 mb-5">
        ...
        <h2 className="mt-3">Fond of Math</h2>
      <Row className="justify-content-center mt-3">
      
        <Col xs={12} md={6} lg={4}>
          <Link to="/summation" className="text-decoration-none">
            <Card className="mb-4">
              <Card.Header className="text text-danger"><strong>Summation Challenge</strong></Card.Header>
                <Card.Body>
                 
                  <Card.Text class="text text-info">                 
                  <h2 class="text-center text-primary mt-3 mb-3">{scnum1} + {scnum2} = ?</h2>
                  It is an engaging way to practice addition by finding the sum of two numbers. Players are presented with a series of problems, and they earn points for each correct answer. Each problem provides three answer options, with only one being correct. 
                  </Card.Text>
                </Card.Body>
              <Card.Footer><button type="button" class="btn btn-success float-end">Play Now</button></Card.Footer>
            </Card>
          </Link>
        </Col>
        <Col xs={12} md={6} lg={4}>
          <Link to="/arithmetic" className="text-decoration-none">
            <Card className="mb-4">
            <Card.Header className="text text-danger"><strong>Arithmetic Sprint</strong></Card.Header>
                <Card.Body>                 
                  <Card.Text class="text text-info">                 
                  <h2 class="text-center text-primary mt-3 mb-3">{acnum1} {newSign} {acnum2} = ?</h2>
                  It is an interactive platform to enhance arithmetic skills. Users are presented with arithmetic problems involving various operations such as addition, subtraction, multiplication, and division. It offers multiple-choice options for each problem.
                  </Card.Text>
                </Card.Body>
              <Card.Footer><button type="button" class="btn btn-success float-end">Play Now</button></Card.Footer>
            </Card>
        ...
        <Col xs={12} md={6} lg={4}>
          <Link to="/times" className="text-decoration-none">
            <Card className="mb-4">
            <Card.Header className="text text-danger"><strong>Times Sprint</strong></Card.Header>
                <Card.Body>                 
                  <Card.Text class="text text-info">                 
                  <h2 class="text-center text-primary mt-3 mb-3">{tcnum1} X {tcnum2} = ?</h2>
                  It is designed to improve multiplication proficiency in a stimulating way. Participants are tasked with solving multiplication problems within a specified time frame. 
                  </Card.Text>
                </Card.Body>
              <Card.Footer><button type="button" class="btn btn-success float-end">Play Now</button></Card.Footer>
            </Card>
      ...
      <Col xs={12} md={6} lg={4}>
          <Link to="https://mfk.nareshshahi.com/visual-memory" target="_blank" className="text-decoration-none">
            <Card className="mb-4">
            <Card.Header className="text text-danger"><strong>Visual Memory</strong></Card.Header>
                <Card.Body>                 
                  <Card.Text class="text text-info">                 
                    <div class="logo">
                    ...
                    Visual Memory game: Follow and recall block patterns. Starts with 3 blocks, increases with each correct response.
                  </Card.Text>
                </Card.Body>
              <Card.Footer><button type="button" class="btn btn-success float-end">Play Now</button></Card.Footer>
            </Card>
        ...
        <Col xs={12} md={6} lg={4}>
          <Link to="https://mfk.nareshshahi.com/smarter-chimpanzee" target="_blank" className="text-decoration-none">
            <Card className="mb-4">
            <Card.Header className="text text-danger"><strong>Smart Chimpanzee</strong></Card.Header>
                <Card.Body>                 
                  <Card.Text class="text text-info">                 
                    <div class="logo">
                        <span class="lsqr"></span>
